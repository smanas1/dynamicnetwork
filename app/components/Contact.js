...
const Contact = () => {
  return (
    <div className=" flex items-center justify-center pt-20 h-screen bg-[#F7F5FF]">
      <div className="py-4 px-10 h-72  text-center w-[340px] shadow-lg bg-white rounded-md">
