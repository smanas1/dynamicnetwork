    ...
    return (
        <div className="md:grid  md:grid-cols-2  max-md:pb-10 sm:pt-10 h-screen lg:pt-52  text-white container">
            <div className='flex lg:px-8 xl:ps-40 pt-14 lg:pt-7 flex-col max-md:items-center'>
                ...
                <div>
                    <button className='xl:py-4 py-2 px-6 lg:py-3 lg:px-7 xl:px-9 text-white mt-8 rounded-lg font-bold   lg:text-lg bg-blue-600 hover:bg-blue-700 transition-all hover:rounded-md'>View Package</button>
                </div>
            </div>
